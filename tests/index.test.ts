import { ResizeToFitParams, getResizeToFitUrl, ResizeToFillParams, getResizeToFillUrl } from '../src'
  ...
  describe('subdomain', () => {
    describe('when set subdomain option', () => {
      it('returns imagepix url', () => {
        ...
        expect(url).toBe('https://test.imagepix.app/fit/320/180/c/webp/80/uploads/test.png')
      })
    })
